sap.ui.define([
	...
	onInit: function() {
			...
			var amnt = 0;
			var filterUnpaid = new Filter("stud_payment_instal_3", FilterOperator.EQ, amnt);
			...
			var filterPaid = new Filter("stud_payment_instal_3", FilterOperator.NE, amnt);
			oModel.read("/tb_stud_payment", {
				filters: [filterPaid],
				success: function(oData, oResponse) {
	...
	onClickBill: function(oEvent) {
			...
			var amnt = property.stud_payment_instal_3;
			var res = amnt.split(",");
			var amount = res[0];
