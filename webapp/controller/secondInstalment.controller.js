sap.ui.define([
	...
	return Controller.extend("com.demoTMS.controller.secondInstalment", {
		...
		onInit: function() {
			...
			var amnt = 0;
			var filterUnpaid = new Filter("stud_payment_instal_2", FilterOperator.EQ, amnt);
			...
			var filterPaid = new Filter("stud_payment_instal_2", FilterOperator.NE, amnt);
			oModel.read("/tb_stud_payment", {
				filters: [filterPaid],
				success: function(oData, oResponse) {
		...
		onClickBill: function(oEvent) {
			...
			var amnt = property.stud_payment_instal_2;
			var res = amnt.split(",");
			var amount = res[0];
